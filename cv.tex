...
\section{Work experience}
    ...
    \smallskip
     ...
     \smallskip
     \coloredbullet\ %
      Developed loosely coupled solutions on SharePoint with .NET + Vue.js or on power Platform with Power Apps \& Azure Functions 
    ...
    \smallskip
    \coloredbullet\ %
    Improved data flow between engineering software (e.g. Siemens COMOS), by designing and implementing custom ETL processes using .NET technologies (e.g., RulesEngine), enhancing data quality and availability locally.
...
\section{Selected Projects}
    ...
    \datedexperience{Rule-Based System for Plant Equipment Classification and Reporting}{Mar 2021 - today}
     ...
     %
     \datedexperience{Data Transformation for Plant Engineering Tools}{Sep 2023 - Dec 2023}
\section{Education} 
