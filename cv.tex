...
\section{Selected Projects}
    ...
    \explanationdetail{
        \smallskip 
        \coloredbullet\ %
         As part of the organization’s digitalization initiative, I implemented workflow solutions for quick-win opportunities the Power Platform.
         }%
    %
    ...
    \explanationdetail{
        \smallskip 
        \coloredbullet\ %
         Developed a flexible rule-based system using .NET and Microsoft RulesEngine to assess chemical plant equipment properties, enabling accurate classification and enhanced reporting for improved operational insights.
         }%
     %
     \datedexperience{Chemical Plant Engineering Tools}{Sep 2023 - Dec 2023}
\section{Education} 
